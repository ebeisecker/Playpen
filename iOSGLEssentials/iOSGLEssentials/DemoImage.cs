...
namespace iOSGLEssentials
{
	public class DemoImage
	{
		...
		public static DemoImage LoadImage(string filePathName, bool flipVertical)
		{
			...
			using(var context = new CGBitmapContext(dataPtr, image.Width, image.Height, 8, image.RowByteSize, cgImage.ColorSpace, CGImageAlphaInfo.NoneSkipLast))
			{
			...
			{
				Marshal.PtrToStructure(dataPtr, image.Data);
			}
